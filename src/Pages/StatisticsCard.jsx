  ...
  return (
    <div className='StatisticsCardContainer'>
        <div className='StatisticsCard'>
            <img src='/public/assets/icon-brand-recognition.svg' alt='Brand recognition'className='image'/>
        ...
        <div className='StatisticsCard2'>
            <img src='/public/assets/icon-detailed-records.svg' alt='Detailed Records' className='image'/>
        ...
        <div className='StatisticsCard3'>
            <img src='/public/assets/icon-fully-customizable.svg' alt='Fully Customizable' className='image'/>
